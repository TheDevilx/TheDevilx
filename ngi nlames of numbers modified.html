...
// vers = 0: right before illion, 1: tier-2 separator, 2: tier-3 separator
	var nums = ["","kal","mej","gij","ast","lun","ferm","jov","sol","bet","gloc","gax","sup","vers","mult","pyr"];
	var nums2 = ["","al","ej","ij","ast","un","erm","ov","ol","eet","oc","ax","up","ers","ult"]; // using eet instead of et because of the sequence bet,det,tret,tet,pet can cause confusion with meg,gig,ter,pet with pet having two possible meanings.
	var numberName = "";
	num = Math.floor(num);
	if (num > 14 || num <= 0) {
		return "";
...
function valueNumber(t) {
	...
	return "one " + "nonecxen".fontcolor("green") + "ulti".fontcolor("red") + "nonecxen".fontcolor("green") + "ersi".fontcolor("red") + "nonecxen".fontcolor("green") + "up".fontcolor("red") + "illion";
}
